 ...
 * @param <T>
 */
public class LQTableTextCell<S, T> extends LQTableCell<S, T> {
    ...
    @Override
    public LQTableTextCell clone() throws CloneNotSupportedException {
        try {
            LQTableTextCell<S, T> hipTableCell = this.getClass().newInstance();
            ...
            Logger.getLogger(LQTableTextCell.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
