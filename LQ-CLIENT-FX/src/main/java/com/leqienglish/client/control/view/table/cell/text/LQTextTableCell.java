 ...
 * @param <T>
 */
public class LQTextTableCell<S, T> extends LQTableCell<S, T> {
    ...
    @Override
    public LQTextTableCell clone() throws CloneNotSupportedException {
        try {
            LQTextTableCell<S, T> hipTableCell = this.getClass().newInstance();
            ...
            Logger.getLogger(LQTextTableCell.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
