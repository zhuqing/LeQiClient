 ...
 */
package com.leqienglish.client.control;
 ...
 *
 */
public class CustomSkin<C extends Control, BB extends BehaviorBase<C>> extends BehaviorSkinBase<C, BB> {

    private static final Logger LOGGER = LogManager.getLogger(CustomSkin.class);
     ...
     * @param behavior
     */
    protected CustomSkin(final C control, BB behavior) {
